...
class FavoriteLocalDataSource(private val teamDao: TeamDao) : TeamDataSource.Local {
    override fun removeFavoriteTeam(teamId: String) = teamDao.removeFavoriteTeam(teamId)
    ...
    override fun saveFavoriteTeam(teamId: String) = teamDao.insertFavoriteTeam(teamId)
}
